...
export const metadata: Metadata = {
  title: "About",
  description:
    `Learn about ${brandName}, a producer and music promoter covering dance, house, hip hop, trance, trap, reggae, jungle, DnB, ambient, and techno.`,
  alternates: {
    canonical: "/about",
  },
};
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <h1 className="max-w-4xl text-5xl font-semibold text-zinc-50">
              {brandName} is a producer and music promoter with a wide
              underground electronic range.
            </h1>
          </div>
          <BrandLogo className="h-60 w-full max-w-xs" sizes="320px" />
        </div>
      </section>
      ...
      <section className="px-5 py-14 sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-6 text-lg leading-8 text-zinc-400">
            <p>
              {brandSentenceName} is the music channel and public brand for a
              producer and promoter focused on original tracks, visual releases,
              and artist-facing music promotion. The catalogue moves across
              dance, house, hip hop, trance, trap, reggae, jungle, DnB, ambient,
              and techno without losing its dark black-and-gold identity.
            </p>
            <p>
            ...
            <p>
              This site keeps the catalogue simple and fast, while giving future
              releases, remixes, collaborations, playlists, and promotional
              campaigns a clear home at ghostrance.com.
            </p>
            <Link
              href="/contact"
