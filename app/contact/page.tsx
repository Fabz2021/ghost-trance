...
export const metadata: Metadata = {
  title: "Contact",
  description:
    `Contact ${brandName} for promotion, collaborations, videos, artist promotion, remixes, YouTube releases, and electronic music enquiries.`,
  alternates: {
    canonical: "/contact",
  },
};
...
export default function ContactPage() {
  const emailHref = `${contactEmailHref}?subject=GHOSTRANCE%20Promotion%20Enquiry`;
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
              {brandSentenceName} is open to relevant promotion,
              collaborations, videos, artist promotion, remixes, and general
              enquiries across electronic, club, bass, and hip-hop-adjacent
              releases. Share a concise note, links to the music, and the
              release timeline.
            </p>
          </div>
          ...
          >
            ...
            <h2 id="contact-details" className="mt-3 text-2xl font-semibold">
              {brandName}
            </h2>
            <div className="mt-5 space-y-3 text-lg">
              <a
                href={emailHref}
                className="block text-[#f0d38a] transition hover:text-white"
              >
                {contactEmail}
              </a>
              <a
        ...
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 rounded-lg border border-white/10 bg-black/40 p-6 sm:flex-row sm:items-center">
          <div>
            <h2 className="text-2xl font-semibold text-zinc-50">
              Explore the tracks first.
            </h2>
            <p className="mt-2 text-zinc-400">
              Review current {brandName} YouTube tracks before sending a
              promotion enquiry.
            </p>
          </div>
          <Link
