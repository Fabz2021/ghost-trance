      ...
      <section className="border-b border-white/10 bg-[linear-gradient(180deg,#0b0b0b_0%,#050505_100%)] px-5 py-16 sm:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="max-w-3xl text-5xl font-semibold text-zinc-50">
            {brandName} tracks are available on YouTube.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
            This catalogue highlights {brandSentenceName} tracks and videos
            with embedded YouTube players, direct listening links, genre tags,
            and individual track pages for each release.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 rounded-lg border border-[#d8b45d]/25 bg-[#111111] p-6 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-3 max-w-2xl leading-7 text-zinc-400">
              Follow the YouTube channel for new videos, promoted tracks,
      ...
      <section className="px-5 py-14 sm:px-8" aria-labelledby="all-tracks">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mb-6 max-w-3xl leading-7 text-zinc-400">
            ...
            YouTube link, and related {brandName} tracks.
          </p>
